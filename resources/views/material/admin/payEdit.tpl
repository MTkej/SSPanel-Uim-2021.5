                ...
                <div class="card">
                    <div class="card-main">
                        <div class="card-inner">
                            ...
                            <div class="form-group form-group-label">
                                <label class="form-label" for="number">失效通知邮箱</label>
                                <input class="form-control maxwidth-edit" id="Notice_EMail" type="text"
                                       value="{$payConfig['Notice_EMail']}">
                            </div>
                            <div class="form-group form-group-label">
                                <label class="form-label" for="number">规定金额设定</label>
                            ...
                            <div class="form-group form-group-label">
                                <label class="form-label" for="amount">支付宝二维码</label>
