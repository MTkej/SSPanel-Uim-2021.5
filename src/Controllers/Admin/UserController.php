    ...
    public function ajax($request, $response, $args)
    {
        ...
        foreach ($users as $user) {
            ...
            $tempdata['op']         = '<a class="btn btn-brand" href="/admin/user/' . $user->id . '/edit">编辑</a>
                    <a class="btn btn-brand-accent" id="delete" href="javascript:void(0);" onClick="delete_modal_show(\'' . $user->id . '\')" data-bs-toggle="modal" data-bs-target="#delete_modal">删除</a>
                    <a class="btn btn-brand" id="changetouser" href="javascript:void(0);" onClick="changetouser_modal_show(\'' . $user->id . '\')"  data-bs-toggle="modal" data-bs-target="#changetouser_modal">切换为该用户</a>';
